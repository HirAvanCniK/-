...
module.exports = async function (client, message, args) {
  ...
  try {
    ...
    //LINKS
    if (!args[0]) return stations(client, prefix, message);
    ...
    if (Number(args[1]) > 150)
      return message.reply("**Maximum Volume is `150`!**");
    ...
    console.log("RADIO:".underline.red + " :: " + e.stack.toString().red);
  }
};
...
function stations(client, prefix, message) {
  try {
    ...
    for (let i = 0; i < radios.EU.Germany.length; i++) {
      United_Kingdom += `**${i + 1 + 10 * amount}** [${radios.EU.United_Kingdom[
        i
      ]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.United_Kingdom[i].split(" ")[1]})\n`;
    }
    amount++;

    let austria = "";
    for (let i = 0; i < radios.EU.Austria.length; i++) {
      austria += `**${i + 1 + 10 * amount}** [${radios.EU.Austria[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Austria[i].split(" ")[1]})\n`;
    }

    amount++;
    let Belgium = "";
    for (let i = 0; i < radios.EU.Belgium.length; i++) {
      Belgium += `**${i + 1 + 10 * amount}** [${radios.EU.Belgium[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Belgium[i].split(" ")[1]})\n`;
    }

    amount++;
    let Bosnia = "";
    for (let i = 0; i < radios.EU.Bosnia.length; i++) {
      Bosnia += `**${i + 1 + 10 * amount}** [${radios.EU.Bosnia[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Bosnia[i].split(" ")[1]})\n`;
    }

    amount++;
    let Czech = "";
    for (let i = 0; i < radios.EU.Czech.length; i++) {
      Czech += `**${i + 1 + 10 * amount}** [${radios.EU.Czech[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Czech[i].split(" ")[1]})\n`;
    }

    amount++;
    let Denmark = "";
    for (let i = 0; i < radios.EU.Denmark.length; i++) {
      Denmark += `**${i + 1 + 10 * amount}** [${radios.EU.Denmark[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Denmark[i].split(" ")[1]})\n`;
    }

    amount++;
    let germany = "";
    for (let i = 0; i < radios.EU.Germany.length; i++) {
      germany += `**${i + 1 + 10 * amount}** [${radios.EU.Germany[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Germany[i].split(" ")[1]})\n`;
    }

    amount++;
    let Hungary = "";
    for (let i = 0; i < radios.EU.Hungary.length; i++) {
      Hungary += `**${i + 1 + 10 * amount}** [${radios.EU.Hungary[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Hungary[i].split(" ")[1]})\n`;
    }

    amount++;
    let Ireland = "";
    for (let i = 0; i < radios.EU.Ireland.length; i++) {
      Ireland += `**${i + 1 + 10 * amount}** [${radios.EU.Ireland[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Ireland[i].split(" ")[1]})\n`;
    }

    amount++;
    let Italy = "";
    for (let i = 0; i < radios.EU.Italy.length; i++) {
      Italy += `**${i + 1 + 10 * amount}** [${radios.EU.Italy[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Italy[i].split(" ")[1]})\n`;
    }

    amount++;
    let Luxembourg = "";
    for (let i = 0; i < radios.EU.Luxembourg.length; i++) {
      Luxembourg += `**${i + 1 + 10 * amount}** [${radios.EU.Luxembourg[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Luxembourg[i].split(" ")[1]})\n`;
    }

    amount++;
    let Romania = "";
    for (let i = 0; i < radios.EU.Romania.length; i++) {
      Romania += `**${i + 1 + 10 * amount}** [${radios.EU.Romania[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Romania[i].split(" ")[1]})\n`;
    }

    amount++;
    let Serbia = "";
    for (let i = 0; i < radios.EU.Serbia.length; i++) {
      Serbia += `**${i + 1 + 10 * amount}** [${radios.EU.Serbia[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Serbia[i].split(" ")[1]})\n`;
    }

    amount++;
    let Spain = "";
    for (let i = 0; i < radios.EU.Spain.length; i++) {
      Spain += `**${i + 1 + 10 * amount}** [${radios.EU.Spain[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Spain[i].split(" ")[1]})\n`;
    }

    amount++;
    let Sweden = "";
    for (let i = 0; i < radios.EU.Sweden.length; i++) {
      Sweden += `**${i + 1 + 10 * amount}** [${radios.EU.Sweden[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Sweden[i].split(" ")[1]})\n`;
    }

    amount++;
    let Ukraine = "";
    for (let i = 0; i < radios.EU.Ukraine.length; i++) {
      Ukraine += `**${i + 1 + 10 * amount}** [${radios.EU.Ukraine[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.EU.Ukraine[i].split(" ")[1]})\n`;
    }

    amount++;
    let requests = "";
    for (let i = 0; i < radios.OTHERS.request.length; i++) {
      requests += `**${i + 1 + 10 * amount}** [${radios.OTHERS.request[i]
        .split(" ")[0]
        .replace("-", " ")}](${radios.OTHERS.request[i].split(" ")[1]})\n`;
    }
    ...
    **Page 18:** \`First 10 custom Requests\`
    ...
    const United_Kingdomembed = new Discord.MessageEmbed()
      .setColor(config.colors.yes)
      .setAuthor(
        "United_Kingdom - Radio Stations",
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-united-kingdom_1f1ec-1f1e7.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const austriaembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-austria_1f1e6-1f1f9.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Belgiumembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-belgium_1f1e7-1f1ea.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Bosniaembed = new Discord.MessageEmbed()
      .setColor(config.colors.yes)
      .setAuthor(
        "Bosnia & Herzegovina - Radio Stations",
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-bosnia-herzegovina_1f1e7-1f1e6.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Denmarkembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-denmark_1f1e9-1f1f0.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Hungaryembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-hungary_1f1ed-1f1fa.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Irelandembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-ireland_1f1ee-1f1ea.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Italyembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-italy_1f1ee-1f1f9.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Luxembourgembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-luxembourg_1f1f1-1f1fa.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Romaniaembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-romania_1f1f7-1f1f4.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Serbiaembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-serbia_1f1f7-1f1f8.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
    ...
    const Swedenembed = new Discord.MessageEmbed()
      ...
      .setAuthor(
        ...
        "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-sweden_1f1f8-1f1ea.png",
        "https://musicium.eu"
      )
      .setFooter(client.user.username, client.user.displayAvatarURL())
